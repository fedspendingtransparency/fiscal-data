module.exports = {
  ...
  ADDITIONAL_ENDPOINTS: {
    ...
    '130': {
      ...
      dataDisplays: [{ dimensionField: 'account_type' }, { dimensionField: 'transaction_type' }],
    ...
    '131': {
      ...
      dataDisplays: [{ dimensionField: 'transaction_type' }],
      valueFieldOptions: ['transaction_today_amt', 'transaction_mtd_amt', 'transaction_fytd_amt'],
    },
    '132': {
      ...
      dataDisplays: [{ dimensionField: 'transaction_type' }, { dimensionField: 'adj_type' }],
    ...
    '134': {
      ...
      dataDisplays: [{ dimensionField: 'tax_deposit_type' }],
    ...
    '136': {
      ...
      dataDisplays: [{ dimensionField: 'tax_refund_type' }, { dimensionField: 'tax_refund_type_desc' }],
