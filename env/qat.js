module.exports = {
  ...
  NOTIFICATION_BANNER_DISPLAY_PAGES: process.env.GENERAL_ALERT_BANNER_PAGES.split(','),
  NOTIFICATION_BANNER_DISPLAY_PATHS: process.env.GENERAL_ALERT_BANNER_PATHS.split(','),
};
