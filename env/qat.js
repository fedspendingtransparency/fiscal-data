module.exports = {
  ...
  STRICT_SSL: true,
  EXPERIMENTAL_ALLOWLIST: ['experimental-page', 'afg-overview', 'publishedReportsSection', 'dataPreview', 'featured-content'],
  LOWER_ENV_FEATURE_ALLOWLIST: ['reportGeneration'],
  ADDITIONAL_DATASETS: {},
