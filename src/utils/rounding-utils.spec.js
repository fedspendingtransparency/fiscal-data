...
describe('Rounding Utils', () => {
  it('getShortForm', () => {
    ...
    expect(getShortForm(valueTrillions, false, false, fractionDigitsTrillion)).toEqual('1.00 trillion');
    expect(getShortForm(valueTrillions, true, false, fractionDigitsTrillion)).toEqual('1.00 T');
  });
  ...
  it('getShortForm rounding', () => {
    ...
    expect(getShortForm(valueTrillions, false)).toEqual('1.00 trillion');
    expect(getShortForm(valueTrillions, true)).toEqual('1.00 T');
  });
  ...
  it('getShortForm non-default fraction digits', () => {
    ...
    expect(getShortForm(valueBillions, false, false, nonDefaultFractionDigitsBillion)).toEqual('100.00 billion');
