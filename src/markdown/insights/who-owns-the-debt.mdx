...
export const footnotes = [
  {
    ...
    "link": 'footnote1',
    "body": 'A full history of the U.S. Savings Bond is available on TreasuryDirect.gov.'
  },
  {
    "text": 'Test Footnote Text2',
    "link": 'footnote2',
    "body": `The breakdown between short-term and long-term securities by country and region is available through the Treasury International Capital System.`
  }
]
