...
describe('Search Results', () => {
  it('places the section title', () => {
    const { getByText } = render(
      <SearchResults allDatasets={mockAllDatasets} filteredDatasets={mockFilteredDatasets} totalCount={mockTotal} searchIsActive={searchIsActive} />
    );
  ...
  it('places the search result count component twice', () => {
    ...
    const text = getSearchResultText(mockFilteredDatasets.length, mockAllDatasets.length, apiFilteredCount, apiTotalCount);
  ...
  it('displays an info box when no search results are returned', () => {
    ...
    rerender(<SearchResults allDatasets={mockAllDatasets} filteredDatasets={[]} totalCount={mockTotal} searchIsActive={false} />);
