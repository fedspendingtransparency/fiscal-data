...
export const mockDatasets = [
  {
    ...
    techSpecs: {
      ...
      lastUpdated: format(testVariables.dates.withinNinetyDays_Updated, testVariables.dateFormats.displayFormat),
    },
    apis: [
      {
        apiId: 3,
        latestDate: format(testVariables.dates.withinNinetyDays, testVariables.dateFormats.isoDate),
        lastUpdated: format(testVariables.dates.withinNinetyDays_Updated, testVariables.dateFormats.isoDate),
  ...
  },
  {
    ...
    filters: ['ninetyDays', 'startDateRangeTwo', 'csv', 'lastYear'],
    apis: [
      {
        apiId: 4,
  ...
  },
  {
    ...
    filters: ['startDateRangeFour', 'lastYear', 'ninetyDays', 'thirtyDays'],
    apis: [
      {
        apiId: 100,
        latestDate: '2021-08-01',
    ...
    apis: [
      {
        ...
        latest_date: format(testVariables.dates.withinNinetyDays, testVariables.dateFormats.isoDate),
        last_updated: format(testVariables.dates.withinNinetyDays_Updated, testVariables.dateFormats.isoDate),
      },
      {
        api_id: 5,
        earliest_date: '1997-10-31',
        latest_date: format(testVariables.dates.outsideNinetyDays, testVariables.dateFormats.isoDate),
        last_updated: format(testVariables.dates.outsideNinetyDays_Updated, testVariables.dateFormats.isoDate),
      },
    ],
  },
  {
    ...
    apis: [
      {
        ...
        latest_date: format(testVariables.dates.withinSixtyDays, testVariables.dateFormats.isoDate),
        last_updated: format(testVariables.dates.withinSixtyDays_Updated, testVariables.dateFormats.isoDate),
      },
    ],
  },
  {
    ...
    apis: [
      ...
      },
      {
        ...
        latest_date: format(testVariables.dates.withinThirtyDays, testVariables.dateFormats.isoDate),
        last_updated: format(testVariables.dates.withinThirtyDays_Updated, testVariables.dateFormats.isoDate),
      },
    ],
  },
];
...
export const mockUpdatedMetadataDatasets = [
  {
    ...
    filters: ['lastYear', 'startDateRangeThree'],
    apis: [
      {
        apiId: 3,
        earliestDate: '1950-01-01',
  ...
  },
  {
    ...
    techSpecs: {
      ...
      latestDate: format(testVariables.dates.withinSixtyDays, testVariables.dateFormats.displayFormat),
      fileFormat: 'JSON, CSV, XML',
      lastUpdated: format(testVariables.dates.withinSixtyDays_Updated, testVariables.dateFormats.displayFormat),
    },
    filters: ['ninetyDays', 'startDateRangeTwo', 'csv'],
    apis: [
      {
        apiId: 4,
        earliestDate: '2000-01-31',
        latestDate: format(testVariables.dates.withinSixtyDays, testVariables.dateFormats.isoDate),
        lastUpdated: format(testVariables.dates.withinSixtyDays_Updated, testVariables.dateFormats.isoDate),
        fields: [
          {
            columnName: 'some_crazy_name',
            prettyName: 'SomeCrazyName',
  ...
  },
  {
    ...
    techSpecs: {
      ...
      fileFormat: 'JSON, CSV, XML',
      lastUpdated: format(testVariables.dates.withinThirtyDays_Updated, testVariables.dateFormats.displayFormat),
    },
    ...
    apis: [
      ...
      },
      {
        ...
        latestDate: format(testVariables.dates.withinThirtyDays, testVariables.dateFormats.isoDate),
        lastUpdated: format(testVariables.dates.withinThirtyDays_Updated, testVariables.dateFormats.isoDate),
      },
    ],
  },
];
...
export const datasetPageSampleConfig = {
  ...
  dataStartYear: 2002,
  tagLine:
    'High level overview of Treasury securities and the statutory debt limit, ' +
    'detailed data on outstanding securities, and holdings of treasury securities in ' +
    'stripped form.',
  summaryText:
    'The Monthly Statement of the Public Debt is a report dating back to ' +
