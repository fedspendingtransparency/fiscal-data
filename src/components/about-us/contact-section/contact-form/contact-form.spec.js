...
// Skipping tests in this file. Component is experimental. If component is ever used on the site, these tests will need
// to be updated to use react testing library
...
describe.skip('About Us - Contact Form', () => {
...
describe.skip('recaptcha component', () => {
  // let component = renderer.create();
  // renderer.act(() => {
  //   component = renderer.create(<Contact />);
  // });
