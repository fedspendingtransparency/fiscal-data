...
const DatasetDetailFields = ({ apis, tabindex }) => {
  ...
  const children = (
    <>
      ...
      <div className={sectionBody} id="fields-datatypes">
        ...
        <strong>All data is returned as a string</strong>, including nulls. Refer to the chart above for the intended data type of each field.
      </div>
    </>
  );
  ...
  return <ApiQuickGuideSection id="fields-section" title={header.title} description={header.desc} children={children} />;
};
