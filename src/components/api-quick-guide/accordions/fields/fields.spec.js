...
describe('Fields Accordion', () => {
  ...
  const longUrlForParam2 = 'https://api.fiscaldata.treasury.gov/services/api' +
    '/fiscal_service/mock/end/point?fields=first,second,third';
  ...
  and long examples, and the long example should contain the dynamic endpoint`, () => {
    const { getByTestId } =
      render(<FieldsAccordion selectedTable={mockSelectedTable} numberOfFields={7} />);
