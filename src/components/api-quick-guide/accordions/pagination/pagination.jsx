    ...
    <Accordion title="Pagination">
      <ul className={list}>
        ...
        <li>
          ...
          <span>
            The page size will set the number of rows that are returned on a request, and page number will set the index for the pagination, starting
            at 1. This allows the user to paginate through the records returned from an API request.
          </span>
        </li>
        <li>
          <strong>Accepts: </strong>
          <span>
            The <code className="inline">page[number]=</code> and <code className="inline">page[size]=</code> parameters both accept integers.
          </span>
        </li>
        <li>
        ...
        <li>
          ...
          <span>When no page number or page size parameter is specified, the default response is</span>
          <ul>
            <li>Page number: 1</li>
            <li>Page size: 100</li>
          </ul>
