...
export default function DimensionControl(props) {
  ...
  return (
    <div>
      <label>
        Enable
        <input type="checkbox" onChange={handleControlChange} checked={active} />
      </label>
      <label>
        &nbsp;&nbsp;&nbsp;Category&nbsp;
        <select defaultValue={key} onChange={e => handleControlChange('key', e)}>
      ...
      <label>
        &nbsp;&nbsp;&nbsp;Value&nbsp;
        <select defaultValue={value} onChange={e => handleControlChange('value', e)}>
          {dimensions.values.map(v => (
