    ...
    <>
      ...
      {width < pxToNumber(breakpointLg) && (
        <>
          ...
          {filterDropdownButton} {active && <DataPreviewMobileDialog onClose={handleCancel} filterName="Filters" searchText="Search filters" filterComponent={<DataPreviewMobileFilterList />} />}
        </>
      )}
    </>
  );
