...
const DataTable2Provider = ({ children, config, detailViewState, pivotSelected }) => {
  ...
  useEffect(() => {
    ...
    if (tableProps) {
      ...
      setColumnVisibility(defaultSelection && defaultSelection.length > 0 && !pivotSelected ? defaultInvisibleColumns : {});
    }
  }, [tableProps]);
...
export default DataTable2Provider;
