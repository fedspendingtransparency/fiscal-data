    ...
    <div className={chartContainer} role="figure" aria-label={altText}>
      ...
      {datasetDateRange && (
        <div className={dateRangeContainer}>
          ...
          />
          <InfoTip title={'For a date range under two years, the data is presented in a bar chart. For a date range greater than two year, the visualization will display a line chart.'} iconStyle={{ color: '#666666', width: '16px', height: '16px' }}  >For a date range under two years, the data is presented in a bar chart. For a date range greater than two year, the visualization will display a line chart. </InfoTip>
        </div>
