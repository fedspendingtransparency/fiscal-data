...
describe('DTG table column selector', () => {
  it('should display columns for selection', () => {
    const { getByText } = render(<DtgTableColumnSelector fields={TestData} isVisible={true} />);
  ...
  it('should display Columns for mobile', () => {
    ...
    const { getByText, queryByText } = render(<DtgTableColumnSelector fields={TestData} isVisible={true} />);
  ...
  it('should display reset button', () => {
    const { getByRole } = render(<DtgTableColumnSelector fields={TestData} isVisible={true} />);
