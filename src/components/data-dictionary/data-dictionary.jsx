...
const columnConfig = [
  { property: 'tableName', name: 'Data Table Name', order: 1, width: 12 },
  { property: 'columnName', name: 'Field Name', order: 2, width: 12 },
  { property: 'prettyName', name: 'Display Name', order: 3, width: 12 },
  { property: 'definition', name: 'Description', order: 4, width: 40 },
  { property: 'dataType', name: 'Data Type', order: 5, width: 9 },
  { property: 'isRequired', name: 'Is Required', order: 6, width: 9 },
];
