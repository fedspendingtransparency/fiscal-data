...
import { container, leftContent, rightContent, downloadWrapper } from './published-reports.module.scss';
    ...
    <>
      <div className={container} data-testid="filterDownloadContainer">
        <div className={leftContent}>
          <FilterSection reports={selectedReportGroup} setSelectedFile={setSelectedFile} reportsTip={dataset.publishedReportsTip} />
        </div>
