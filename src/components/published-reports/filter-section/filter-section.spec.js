...
describe('Filter Section', () => {
  ...
  beforeEach(() => {
    component = renderer.create(<FilterSection reports={reports} setSelectedFile={selectedFileMock} />);
  ...
  available`, () => {
    ...
    const comboCaseComponent = renderer.create(<FilterSection reports={manyYearOptions} setSelectedFile={selectedFileMock} />);
  ...
  correctly handles switching between daily and non-daily report groups`, () => {
    ...
    const dayComponent = renderer.create(<FilterSection reports={dailyReports} setSelectedFile={mockFileSetter} />);
    ...
    renderer.act(() => reportGroupSelector.props.changeHandler(reportGroupSelector.props.options[1]));
    ...
    expect(dailyReports[1].daily).toBeFalsy();
    ...
    renderer.act(() => reportGroupSelector.props.changeHandler(reportGroupSelector.props.options[0]));
