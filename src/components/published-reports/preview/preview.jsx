...
import { titleContainer, headerWrapper, header, previewContent, textReportContainer, textReportPreview } from './preview.module.scss';
...
const Preview = ({ selectedFile }) => {
  ...
  useEffect(() => {
    if (selectedFile && selectedFile.path !== previousSelectedPath && selectedFile.report_group_desc && selectedFile.path) {
    ...
    <>
      <div className={titleContainer}>
        <div className={headerWrapper}>
          <FontAwesomeIcon icon={faTable} data-testid="tableIcon" size="1x" />
          <h3 className={header} data-testid="title" id="main-data-table-title">
      ...
      <div data-testid="previewContent" className={previewContent}>
        {selectedFile ? (
          isPdf ? (
            ...
            <iframe src={selectedFile.path} title={altText} style={{ width: '100%', height: '600px' }} data-test-id="embedElement" />
          ) : isTxt ? (
