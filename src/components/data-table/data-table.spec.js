...
describe('react-table', () => {
  ...
  it('renders headers', () => {
    ...
    expect(getByRole('columnheader', { name: 'Record Date Start |' })).toBeInTheDocument();
  });
  ...
  it('Able to interact with headers for column sort', () => {
    ...
    const header = getByRole('columnheader', { name: 'Record Date Start |' });
