...
describe('glossary list container', () => {
  it('contains the initial list header', () => {
    const { getByText } = render(<GlossaryListContainer sortedTermList={testSortedGlossaryData} filter={''} filterHandler={jest.fn()} />);
  ...
  it('displays the no match found message when the search filter does not match any terms', () => {
    const { getByText } = render(<GlossaryListContainer sortedTermList={testSortedGlossaryData} filter={'orange'} filterHandler={jest.fn()} />);
  ...
  it('ignores case from the search filter', () => {
    const { getByText } = render(<GlossaryListContainer sortedTermList={testSortedGlossaryData} filter={'pEAr'} filterHandler={jest.fn()} />);
