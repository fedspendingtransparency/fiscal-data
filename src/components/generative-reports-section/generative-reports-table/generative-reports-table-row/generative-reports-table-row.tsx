...
import {
  ...
  downloadButton,
  endName,
} from './generative-reports-table-row.module.scss';
...
const GenerativeReportsTableRow: FunctionComponent<{ reportFile: IPublishedReportDataJson; isDailyReport: boolean; mobileView?: boolean }> = ({
  reportFile,
  isDailyReport,
  mobileView,
}) => {
...
export default GenerativeReportsTableRow;
