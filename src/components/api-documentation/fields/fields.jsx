  ...
  <>
    ...
    >
      <p>
        ...
        quotation marks (e.g., "field_name"). The data type listed in a dataset's data dictionary
        or Fields table in dataset-specific API documentation indicates what the field is meant to
        be (e.g., date).{' '}
        <strong>Note: This includes null values,</strong> which will appear as strings ("null")
        rather than a blank or system-recognized null value. This allows you to{' '}
        <strong>convert it to that data type in your language of choice.</strong> For example, the
        Pandas library for Python helps you convert strings to 'datetime objects' and R allows you
        to convert characters to date objects using as.Date. 
      </p>
    </SectionContent>
    <SectionContent
    ...
    >
      <p>
        ...
        corresponding dataset's detail page for dataset-specific API documentation or refer to its
        data dictionary.
      </p>
      <p>
