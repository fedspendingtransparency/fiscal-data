...
const DataRegistry = () => (
  <div className={apiStyles.sectionBreak}>
    ...
    >
      <p>
        The <CustomLink url={dataRegistryUrl}>data registry</CustomLink> contains information
        about definitions, authoritative sources, data types, formats, and uses of common data
