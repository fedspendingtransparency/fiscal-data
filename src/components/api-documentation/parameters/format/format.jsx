...
const Format = () => (
  <SectionContent title="Format" id="parameters-format" headingLevel={3}>
    ...
    <p>
      <strong>Definition:</strong> The format parameter allows a user to define the output method of the response (CSV, JSON, XML).
    </p>
    <p>
      <strong>Accepts:</strong> The <code className="inline">format=</code> parameter accepts <code className="inline">xml</code>,{' '}
