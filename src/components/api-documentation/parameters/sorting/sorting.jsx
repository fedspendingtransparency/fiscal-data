...
const Sorting = () => (
  ...
  >
    ...
    <p>
      ...
      first column listed. Most API endpoints are thus sorted by date in ascending order (historical
      to most current).
    </p>
    <p>
    ...
    <p>
      ...
      order i.e., least to greatest.
    </p>
    <code className={`${apiStyles.code} ${apiStyles.marginBottom}`}>
      {baseApiUrl}/v2/debt/tror?sort=funding_type_id
    </code>
