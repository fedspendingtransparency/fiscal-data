...
const ErrorObject = () => (
  <SectionContent id="responses-error-object" headingLevel={3} title="Error Object">
      <p>
        If something goes wrong while creating the API response, an error object will be returned to the user. The error
      ...
      <ul>
        <li>
          <code className="inline">Message:</code> A detailed explanation of why the error occurred and how to resolve
          it.
        </li>
      </ul>
      <p>
