...
const SocialShareDropdown: FunctionComponent<ISocialShareDropdown> = ({ copy, pageName, width }) => {
  ...
  return (
    <>
      <SocialMetaData image={copy.image} title={copy.title} description={copy.description} url={copy.url} />
      <button className={shareButton} tabIndex={0} onClick={handleClick} onKeyPress={handleClick}>
