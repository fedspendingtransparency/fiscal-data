...
describe('Contact Us section', () => {
  ...
  describe('layout tests', () => {
    ...
    it('renders the proper form elements', () => {
      expect(instance.findByType(SelectControl).props.label).toEqual('Subject');
      expect(instance.findByProps({ 'id': 'contactUsName' }).type).toBe('input');
      expect(instance.findByProps({ 'id': 'contactUsEmail' }).type).toBe('input');
      expect(instance.findByProps({ 'id': 'contactUsComment' }).type).toBe('textarea');
    });
  });
