...
const FAQ = ({ triggerHighlight = 0 }) => {
  ...
  const whoCanIContactPreface = (
    <>
      Because Fiscal Data's focus is publicly available government data, we do not have access to personal data and cannot assist with personal
      inquiries. For personal inquiries, please contact the following departments and agencies:
    </>
  );
  ...
  const whoToContactOptions = (
    <ul className={[list, noBullets].join(' ')}>
      <li>
        ...
        or <CustomLink url="https://fiscal.treasury.gov/top/contact.html"> visit their Contact Us page</CustomLink> for more details.
      </li>
      <li>
      ...
      <li>
        For child support inquiries, please contact your state's Attorney General at the Office of the Attorney General and/or contact your local
        Child Support Division.
      </li>
      <li>
        For additional topics, <CustomLink url="https://fiscal.treasury.gov/contact/">contact the Bureau of the Fiscal Service</CustomLink>.
      </li>
    </ul>
  );
  ...
  return (
    <div className={`${section} ${noBullets}`}>
      ...
      <SectionContent
        id="how-is-data-being-rolled-out-on-website"
        headingLevel={commonSectionHeadingLevel}
      ...
      <SectionContent
        id="how-can-i-learn-about-updates-to-site"
        headingLevel={commonSectionHeadingLevel}
      ...
      <SectionContent id="when-is-new-data-uploaded-to-site" headingLevel={commonSectionHeadingLevel} title="When is new data uploaded to the site?">
        <p>
          We will continue to add more datasets to the site over time. To receive email updates about new features and datasets,{' '}
          <CustomLink
            url="mailto:join-fiscal-data-gov@lists.fiscal.treasury.gov?subject=Yes,
      ...
      <SectionContent
        id="why-datasets-go-further-than-others"
        headingLevel={commonSectionHeadingLevel}
        title="Why do some datasets go back further than others?"
      >
        <p>
          The answer varies by dataset. Some data started being recorded as the result of specific legislation and others became available as a result
          of new data systems put in place. We strive to provide as much data as is available for each dataset and will continue working to provide as
          much historical data as possible.
        </p>
      </SectionContent>
      <SectionContent id="new-to-apis" headingLevel={commonSectionHeadingLevel} title="I’m new to using APIs. How can I start using your APIs?">
        <p>
          You can find all the information you’ll need to access our data via APIs on the{' '}
          <CustomLink url="/api-documentation/">API Documentation</CustomLink> page. You may find the <strong>Getting Started</strong> section most
          helpful.
        </p>
      </SectionContent>
      <SectionContent
        id="taxes-stimulus-inquiries"
        headingLevel={commonSectionHeadingLevel}
      ...
      >
        <div>
          <p>
            Because Fiscal Data's focus is publicly available government data, we do not have access to personal data and cannot assist with personal
            inquiries. For personal inquires, please contact the following departments and agencies:
          </p>
          {whoToContactOptions}
        </div>
      </SectionContent>
      <SectionContent
        id="who-can-i-contact"
        headingLevel={commonSectionHeadingLevel}
        title="Who can I contact if I have questions about the data or wish to make a suggestion?"
      >
        <p>
          Please <CustomLink url="mailto:fiscaldata@fiscal.treasury.gov?subject=Contact Us">contact us</CustomLink> with questions about the data or
          to submit recommendations.
        </p>
        <div>
          <p>{highlight ? <mark>{whoCanIContactPreface}</mark> : whoCanIContactPreface}</p>
          {whoToContactOptions}
        </div>
      </SectionContent>
    </div>
