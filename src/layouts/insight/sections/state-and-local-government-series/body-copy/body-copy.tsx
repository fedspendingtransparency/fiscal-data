...
export const getLastDayOfEachMonth = async () => {
...
export const BodyCopy = (): ReactElement => {
  return (
    <div>
      ...
      regulations. SLGS also serve the federal government as
      {/*a means of financing the federal debt, similar to other treasury securities. As of {Month DD, YYYY (latest*/}
      {/*date for both SLGS and Debt to the Penny data)}, there are {$XXX B (SLGS total)} outstanding SLGS securities,*/}
      {/*{XX} percent of the total public debt outstanding.*/}
    </div>
  );
};
