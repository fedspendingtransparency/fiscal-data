...
export const HistoricGovtSpendingBody = (): ReactElement => {
  ...
  } = featuredContentCitationsMap['historic-govt-spending'];

  return (
    <div>
      <p>
        The {accountsOfReceiptsAndExpendituresDataset} has all the details! The earliest report from 1793, now available on Fiscal Data, includes
        expenses to individuals and companies who supplied the Department of War with supplies.
      </p>
      ...
      <p>
        ...
        be found at an aggregate level in the {monthlyTreasuryStatementDataset} or in detail on {usaSpending}.
      </p>
      ...
      <p>
        To explore more historic spending, revenue, and deficits, check out all of the {accountsOfReceiptsAndExpendituresDataset} files or the ongoing{' '}
        {combinedStatementDataset} for nearly 250 years of continuous financial reporting of the United States!
      </p>
    </div>
  );
};
