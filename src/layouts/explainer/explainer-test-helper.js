...
export const mockFifthSectionValueMarkers = ['$10.26 T', '$4.74 T', '$22.64 T', '$6.27 T'];
...
export const mockBeaGDPDataForRevenueChart = {
  finalGDPData: [
    {
      x: 2015,
...
export const mockSavingsBondTypesData = {
  data: [
    {
