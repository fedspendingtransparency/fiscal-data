...
const ChartTopNotch = (props: ActiveShapeProps, activeIndex, inactive = false) => {
  ...
  if (index === activeIndex && inactive && (index !== activeIndex || !inactive)) {
    console.log(inactive, index === activeIndex && inactive, index !== activeIndex || !inactive);
  }
  return (
    <>
