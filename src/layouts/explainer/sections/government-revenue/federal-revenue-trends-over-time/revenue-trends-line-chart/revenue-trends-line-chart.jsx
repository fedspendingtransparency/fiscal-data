...
const RevenueTrendsLineChart = ({ width, cpiDataByYear }) => {
  ...
  //     color: '#0a2f5a',
  //     data: [
  //       { x: '2024', y: 2.43, raw: 2426066988325.89 },
  //       { x: '2023', y: 2.24, raw: 2239338655433.0757 },
  //       // { x: '2022', y: NaN, raw: NaN },
  //       { x: '2021', y: 2.35, raw: 2352140333832.4927 },
  //     ],
  //   },
  //   {
  ...
  //     color: '#eb5160',
  //     data: [
  //       { x: '2024', y: 1.71, raw: 1709558485436.4 },
  //       { x: '2023', y: 1.66, raw: 1661080120733.1519 },
  //       // { x: '2022', y: NaN, raw: NaN },
  //       { x: '2021', y: 1.51, raw: 1511913659691.7393 },
  //     ],
  //   },
  //   {
  ...
  //     color: '#c13f77',
  //     data: [
  //       { x: '2024', y: 0.53, raw: 529866802637.57 },
  //       { x: '2023', y: 0.43, raw: 431701671637.0849 },
  //       // { x: '2022', y: NaN, raw: NaN },
  //       { x: '2021', y: 0.43, raw: 427807351927.2928 },
  //     ],
  //   },
  //   {
