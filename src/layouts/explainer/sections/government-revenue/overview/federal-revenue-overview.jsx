...
const FederalRevenueOverview = () => {
  ...
  const spending = (
    <CustomLink url="/americas-finance-guide/federal-spending/" eventNumber="33" id="Federal Spending">
      Spending
    </CustomLink>
  );

  const deficit = (
    <CustomLink url="/americas-finance-guide/national-deficit/" eventNumber="32" id="National Deficit">
      Deficit
    </CustomLink>
  );
  ...
  return (
    <div>
      <p>
        ...
        likely part of the ${priorRevenue} collected in revenue. The federal government also collects revenue from services like admission to national
        parks and customs duties on foreign imports and exports. The majority of this revenue is used to pay for government activities (employee
