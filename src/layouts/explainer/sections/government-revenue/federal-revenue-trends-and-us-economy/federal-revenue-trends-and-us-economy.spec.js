import FederalRevenueTrendsAndUSEconomy from './federal-revenue-trends-and-us-economy';
...
describe('Sources of Federal Revenue', () => {
  ...
  it('render the quote box', () => {
    const { getByTestId, getByRole } = render(<FederalRevenueTrendsAndUSEconomy cpiDataByYear={mockCpiDataset} />);
