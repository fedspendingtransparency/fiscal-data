...
const SurplusIllustration = ({glossary, width}) => {
  ...
  const tabStyle = width < pxToNumber(1188) ? tabStyleMobile : tabStyleDesktop;
      ...
      <Tabs>
        <TabList style={tabListStyle}>
          <Tab style={tabStyle} data-testid={'surplus-tab'}>
            ...
            {width < pxToNumber(1031) ? <FolderTabEdgeLeftMobile /> : <FolderTabEdgeLeft /> }
            <div className={title}>
              Surplus
            </div>
            {width < pxToNumber(1031) ? <FolderTabEdgeRightMobile /> : <FolderTabEdgeRight /> }
          </Tab>
          ...
          <Tab style={tabStyle} data-testid={'deficit-tab'}>
            ...
            {width < pxToNumber(1031) ? <FolderTabEdgeRightLastMobile /> : <FolderTabEdgeRightLast /> }
          </Tab>
        </TabList>
        <TabPanel>
