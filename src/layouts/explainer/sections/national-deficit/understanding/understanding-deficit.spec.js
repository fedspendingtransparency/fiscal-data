...
describe('Understanding the National Deficit Section', () => {
  ...
  it('renders the text content', () => {
    const { getByTestId } = render(<UnderstandingDeficit sectionId={sectionId} glossary={glossary} />);
  ...
  it('renders the current year label', async () => {
    const { getByText } = render(<UnderstandingDeficit sectionId={sectionId} glossary={glossary} />);
    await waitFor(() => {
