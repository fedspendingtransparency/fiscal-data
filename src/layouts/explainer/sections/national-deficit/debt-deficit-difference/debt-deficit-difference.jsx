  ...
  return (
    <>
      <div className={deficitDebtDifferenceContent} data-testid="textContent">
        ...
        <p>
          The visualization below shows how deficits from previous years are added to the current year’s deficit to equal total debt. This
          illustration is simplified to show how debt and deficit are different. In reality, the U.S. government must pay interest on the national
