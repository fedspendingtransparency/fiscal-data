  ...
  return (
    <>
      ...
      <div className={postGraphContent} id={'maintaining-national-debt'}>
        ...
        >
          <p>
          As of {interestExpenseEndMonth} {interestExpenseEndYear} it costs ${shortenedDebtExpense} billion 
          to maintain the debt, which is {debtExpensePercent} of the total {spendingLink('federal spending')}
          </p>
        </QuoteBox>
        <p>
