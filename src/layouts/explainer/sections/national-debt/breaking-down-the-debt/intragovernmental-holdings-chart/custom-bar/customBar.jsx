...
import { boldWeight, fontBodyCopy, fontSize_36 } from '../../../national-debt.module.scss';
const CustomBar = ({ bar: { x, y, width, height, color, key, data } }) => {
  ...
  return (
    <>
      <animated.rect width={width} height={height} x={x} y={y} fill={color} style={{ ...springs }} />
      <text x={xPos} y={yPos} style={{ ...textStyle }}>
