  ...
  return (
    <>
      <div className={keyTakeawaysContent}>
        ...
        <p>
          The national debt is composed of distinct types of debt, similar to an individual whose debt may consist of a mortgage, car loan, and credit
          cards. The different types of debt include {nonMarketableSecurities} or {marketableSecurities} securities and whether it is debt held by the
          public or debt held by the government itself (known as intragovernmental).
        </p>
      </div>
      <div className={keyTakeawaysContent}>
        <div className={iconBackground}>
        ...
        <p>
          The U.S. has carried debt since its inception. Debts incurred during the American Revolutionary War amounted to $75 million, primarily
          borrowed from domestic investors and the French Government for war materials.
        </p>
      </div>
      <div className={`${keyTakeawaysContent} ${noMarginBottom}`}>
        ...
        <p>The national debt enables the federal government to pay for important programs and services for the American public.</p>
      </div>
    </>
  );
};
