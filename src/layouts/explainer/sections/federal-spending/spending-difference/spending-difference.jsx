...
export const SpendingDifference = ({ width }) => {
  ...
  return (
    <div className={spendingDifferenceContent}>
      ...
      <p>
        Government spending is broken down into two primary categories: mandatory and discretionary. Mandatory spending represents nearly two-thirds
        of annual federal spending. This type of spending does not require an annual vote by Congress. The second major category is discretionary
        spending. The difference between mandatory and discretionary spending relates to whether spending is dictated by prior law or voted on in the
        annual {appropriations} process. Another type of appropriation spending is called {supplementalAppropriations}, in which spending laws are
        passed to address needs that have arisen after the fiscal year has begun.
      </p>
      ...
      <p>
        Discretionary spending is money formally approved by Congress and the President during the appropriations process each year. Generally,
        Congress allocates over half of the discretionary budget towards national defense and the rest to fund the administration of other agencies
        and programs. These programs range from transportation, education, housing, and social service programs, as well as science and environmental
        organizations.
      </p>
      <div className={mandatorySpendingContainer}>
        <picture>
      ...
      <div className={spendingAccordion}>
        ...
        >
          ...
          levels and add or eliminate programs, taxes, and other sources of revenue. Once the budget resolutions have been finalized in the House and
          Senate, Congress reconciles the differences and votes on a final budget. The discretionary spending levels in the budget are divided among
          the twelve Appropriations Subcommittees, which then draft bills providing funding levels for the departments, bureaus, and agencies within
          their jurisdiction. After the House and Senate agree to a final funding level for each bill, they are sent to the President for approval or
          veto.
        </Accordion>
      </div>
    </div>
