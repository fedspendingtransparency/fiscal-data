...
import { debtExplainerPrimary } from '../../../sections/national-debt/national-debt.module.scss';
import { deficitExplainerPrimary } from '../../../sections/national-deficit/national-deficit.module.scss';
import { revenueExplainerPrimary } from '../../../../../pages/americas-finance-guide/afg-overview.module.scss';
  ...
  const subSections = [
    {
      heading: (
        <>
          In {priorFiscalYear} the federal government <span style={{ color: revenueExplainerPrimary, fontStyle: 'italic' }}>collected</span> $
          {revenue}
        </>
      ),
      body: (
        <>
          The primary source of revenue for the U.S. government in {priorFiscalYear} was {revenueCategory}. Revenue collected by the U.S. government
          is used to fund a variety of goods, programs, and services to support the American public and pay interest incurred from borrowing.
        </>
      ),
      faIcon: faCoins,
    ...
    },
    {
      heading: (
        <>
          In {priorFiscalYear}, the federal government <span style={{ color: spendingExplainerPrimary, fontStyle: 'italic' }}>spent</span> ${spending}
        </>
      ),
      body: (
        <>
          Federal government spending pays for everything from Social Security and Medicare to military equipment, highway maintenance, education, and
          more. In {priorFiscalYear}, the federal government spent the most on {spendingCategory}.
        </>
      ),
    ...
    },
    {
      heading: (
        <>
          In {priorFiscalYear}, the federal government spent ${deficit} more than it collected, resulting in a{' '}
          <span style={{ color: deficitExplainerPrimary, fontStyle: 'italic' }}>deficit.</span>
        </>
      ),
      body: (
        <>
          To pay for government programs while operating under a deficit, the federal government borrows money by selling U.S. Treasury bonds, bills,
          and other securities. The national debt is the accumulation of this borrowing along with associated interest owed to investors who purchased
          these securities. In {priorFiscalYear}, the national deficit {deficitDirection} by ${deficitChange} compared to {priorPriorYear}.
        </>
      ),
      faIcon: faChartArea,
    ...
    },
    {
      heading: (
        <>
          At the end of {priorFiscalYear} the government had ${debt} in federal{' '}
          <span style={{ color: debtExplainerPrimary, fontStyle: 'italic' }}>debt.</span>
        </>
      ),
      body: (
        <>
          The national debt enables the federal government to pay for important programs and services for the American public. In {priorFiscalYear},
          the national debt {debtDirection} by ${debtChange} compared to {priorPriorYear}.
        </>
      ),
  ...
  return (
    <div className={styles.compareSection} data-testid="compare-section">
      <h3 className={styles.heading}>
        How did these totals compare to {priorFiscalYear}
        {anchorTextPriorFY(priorFiscalYear, 1, 0)} year-end?
      </h3>
