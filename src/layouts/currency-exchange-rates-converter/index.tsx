      ...
      <div className={legalDisclaimer}>
        <div>
          ...
          <p>
            ...
            <CustomLink
              url="tfx.treasury.gov/tfm/volume1/part2/chapter-3200-foreign-currency-accounting-and-reporting#Section3235TranslatingForeignCurrenciestoUSDollarEquivalents"
